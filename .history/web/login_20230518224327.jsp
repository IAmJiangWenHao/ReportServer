  ...
  <dfv>
    <form action="LoginServlet" method="post" name="form1" onSubmit="return Check()">
      ...
      <table>
        ...
        <tr>
          <td >验证码</td>
          <td style="display:flex;"><input style="width: 412px;height:30px;" type="text" name="checkcode" size="15">
            <img style="width:150px;height:32px; margin-left: 262px;" id="img" src="CheckcodeServlet" alt="[验证码待续]" align="center">
