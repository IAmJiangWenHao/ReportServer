  ...
  <body>
    ...
    <script>
      ...
      function createCourse() {
        var createCell = document.getElementById("createCourse");
        createCell.innerHTML = "<form action=\"../uploadCourseServlet\" enctype=\"multipart/form-data\" method=\"post\" name=\"form1\" onSubmit=\"return Check()\"><table></tr><tr> <td>建课模板：</td><td><a style=\"text-decoration:none; color: whitesmoke;font-size: 20px;background-color: grey;width: 100px; border-radius: 10px;height: 100%;border: 1px solid black;display: inline-flex;justify-content: center;align-items: center;\" href=\"实验课模板.xlsx\">下载</a></td></tr><tr><td>课程名：</td><td><input style=\" font-size:16px\" type=\"text\" name=\"courseName\" size=\"20\"/>(例：程序设计实验)</td></tr><tr><td>班级：</td><td><input style=\" font-size:16px\" type=\"text\" name=\"className\" size=\"20\"/>(例:信安201)</td></tr><tr> <td>文件：</td><td><input style=\"background-color: grey;color: white;border-radius: 10px; font-size:16px\" type=\"file\" name=\"file\" size=\"40\" id=\"fup\" onchange=\'fileChange(this,\".xlsx\");\'/></td><tr><td style=\"height:50px;\" align=\"right\" ><input style=\"background-color: grey;color: white;border-radius: 10px; font-size:16px\" type=\"submit\" value=\"提交\" size='30'/> </td><td align=\"left\"><input style=\"background-color: grey;color: white;border-radius: 10px;font-size:16px\" type=\"button\" value=\"关闭\" size='30' onclick=\"cls()\"/> </td></tr></table></form>";
      }
    </script>
    <div style=" width: 100%;height:100%;position: absolute;display: flex;flex-direction: column;align-items: center;">
      <h1><font color="black"> 实验管理</font><font style="font-size:15px;color:red">&nbsp;&nbsp;&nbsp;&nbsp; <a style="text-decoration: none;
    color: whitesmoke;
    border-radius: 10px;
    font-size: 20px;
    ...
    align-items: center;" href="../exit">安全退出</a></font></h1>  
      <p>
        <img style="vertical-align: middle;height:20px" alt="" width="20" src="../img/new.png"/>                
        <input style="background-color: grey;
        color: white;
        border-radius: 10px;" type="button" value="创建课程" onclick="createCourse()">
      <div id="createCourse">
